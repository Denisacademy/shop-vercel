...
function FavoriteToggleForm({ productId, favoriteId }: { productId: string; favoriteId: string }) {
...
function FavoriteToggleForm_({ favoriteId, productId }: { productId: string; favoriteId: string }) {
  // const toggleAction_ = toggleFavoriteAction.bind(null, {
  //   favoriteId,
  //   productId,
  // });
